    ...
    <main className="relative flex-1 bg-[#FAFAFB] text-[#26222E]">
      ...
      <nav className="sticky top-0 z-50 border-b border-black/5 bg-[#FAFAFB]/80 backdrop-blur-lg">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-5">
          <Link
            href="/"
            className="text-lg font-bold tracking-tight text-[#7C5CFF]"
          >
            TypeMind
          </Link>
          <Link
      ...
      <section className="relative z-10 px-5 pb-12 pt-14 sm:pb-20 sm:pt-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-xs text-[#B0A8BA]">
            约 5-7 分钟 · 免费 · 无需注册 · 仅供自我探索参考
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={title}
                className="rounded-2xl border border-black/5 bg-white/70 p-5 shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-md"
              >
                <div
      ...
      <section className="relative z-10 px-5 py-12 sm:py-20">
        <div className="mx-auto max-w-lg">
          ...
          <div className="overflow-hidden rounded-3xl border border-emerald-200 bg-white/80 shadow-lg backdrop-blur-sm">
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-violet-50 px-6 py-6 text-center">
              ...
              <span className="relative mb-2 inline-block rounded-full bg-emerald-100 px-3 py-0.5 text-xs font-medium text-emerald-700">
                绿人 · 外交家
              </span>
              ...
              <div className="relative mt-3 flex flex-wrap justify-center gap-1.5">
                {["共情", "洞察", "理想感", "深度关系"].map((k) => (
                  <span
                    key={k}
                    className="rounded-full border border-emerald-200 bg-white/70 px-2.5 py-0.5 text-xs text-[#6F6877] backdrop-blur-sm"
                  >
                    {k}
                  </span>
                ))}
            ...
            <div className="px-6 py-5">
              <p className="text-sm leading-relaxed text-[#6F6877]">
                结果会包含你的优势、需要注意的地方、默契类型、磨合类型、关系模式和生活建议。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 px-5 py-12 sm:py-20">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="mb-4 text-2xl font-bold tracking-tight sm:text-3xl">
            准备好看见你的
            <span className="text-[#7C5CFF]">性格底色</span>
            了吗？
          </h2>
          <p className="mb-8 leading-relaxed text-[#6F6877]">
            36 个场景题，约 5-7 分钟。免费，无需注册。
          </p>
          <Link
            href="/test"
            className="inline-flex items-center gap-2 rounded-xl bg-[#7C5CFF] px-8 py-3.5 text-sm font-medium text-white shadow-sm transition hover:bg-[#6A4DE6] hover:-translate-y-0.5 hover:shadow-md active:scale-95"
