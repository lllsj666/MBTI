...
export default function Home() {
  return (
    <main className="flex-1 bg-[#FAFAFB] text-[#26222E]">
      ...
      {/* Hero */}
      <section className="px-5 pb-12 pt-14 sm:pb-20 sm:pt-20">
      ...
      <section className="px-5 py-12 sm:py-20">
        <div className="mx-auto max-w-lg">
          ...
          <div className="overflow-hidden rounded-3xl border border-black/5 bg-white shadow-sm">
            <div className="bg-gradient-to-br from-violet-50 via-white to-emerald-50 px-6 py-6 text-center">
              <span className="mb-2 inline-block rounded-full bg-emerald-100 px-3 py-0.5 text-xs font-medium text-emerald-700">
                绿人 · 外交家
              </span>
              <p className="mb-1 text-4xl font-bold tracking-widest">INFJ</p>
              <div className="flex flex-wrap justify-center gap-1.5 mt-3">
                {["共情", "洞察", "理想感", "深度关系"].map((k) => (
                  <span
                    key={k}
                    className="rounded-full border border-[#E0DCE8] bg-white px-2.5 py-0.5 text-xs text-[#6F6877]"
                  >
                    {k}
                  </span>
                ))}
